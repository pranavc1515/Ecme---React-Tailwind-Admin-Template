...
export default OauthSignIn`}</SyntaxHighlighter>
                    ...
                    <li>
                        ...
                        <p>If you want to use sign-in with email and password with Firebase, you can use the <code>signInWithEmailAndPassword</code> method within  <code>apiSignIn</code> in <code>AuthService.ts</code>. Here’s an example:</p>
